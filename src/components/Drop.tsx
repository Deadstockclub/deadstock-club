...
export default function Drop() {
  return (
    <section className="relative overflow-hidden bg-black text-white px-6 md:px-12 py-28">
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 h-80 w-[800px] -translate-x-1/2 rounded-full bg-white/[0.02] blur-[120px]" />
          ...
          {hats.map((hat, index) => {
            ...
            return (
              ...
              "
                ...
                drop-shadow-[0_20px_35px_rgba(255,255,255,0.03)]
              "
                    />
                  </div>
              ...
              "
                    ...
                    >
                      <span>Archive Access {hat.archive}</span>
